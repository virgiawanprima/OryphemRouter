...
describe("proxyAwareFetch — api.anthropic.com routing", () => {
  ...
  it("routes api.anthropic.com through native fetch (got-scraping disabled) and returns ok response", async () => {
    // got-scraping routing was disabled (see proxyFetch.js comment); api.anthropic.com
    // is served by native fetch. Assert the mock fetch is used and response passes through.
