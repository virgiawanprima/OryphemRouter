...
// Live test — hits a real, rate-limited free upstream. Skipped unless RUN_REAL=1
// (same gate as tests/translator/real/*). The upstream also rotates its model
// catalog, so a hard 200 assertion is not stable in CI.
const RUN_REAL = process.env.RUN_REAL === "1";
const describeLive = RUN_REAL ? describe : describe.skip;
