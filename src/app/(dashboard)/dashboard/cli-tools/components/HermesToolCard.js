          ...
          {!checking && hermesStatus?.installed && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={handleReset} disabled={!hermesStatus?.hasoryphemrouter} loading={restoring} className="w-full sm:w-auto">
