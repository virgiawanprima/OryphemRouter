...
export async function POST(request) {
  try {
    const { baseUrl, apiKey, model, subagentModel } = await parseJson(request);
    ...
    // Update or create oryphemrouter provider section (no api_key - Codex reads from auth.json)
...
export async function DELETE() {
  try {
    ...
    // Remove oryphemrouter provider section
    deleteNestedSection(parsed, "model_providers.oryphemrouter");
