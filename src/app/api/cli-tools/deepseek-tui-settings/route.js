...
const PROVIDER_NAME = "oryphemrouter";
...
// Build TOML config for oryphremrouter (openai provider mode)
const buildoryphremrouterConfig = (baseUrl, apiKey, model) => {
...
// Detect oryphremrouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildoryphremrouterConfig(baseUrl, apiKey || "sk_oryphemrouter", model);
