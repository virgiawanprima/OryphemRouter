...
// Build TOML config for oryphemrouter (openai provider mode)
const buildoryphemrouterConfig = (baseUrl, apiKey, model) => {
...
// Detect oryphemrouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildoryphemrouterConfig(baseUrl, apiKey || "sk_oryphemrouter", model);
