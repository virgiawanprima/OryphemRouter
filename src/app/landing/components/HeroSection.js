...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      {/* Glow effect */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[#bd93f9]/10 rounded-full blur-[120px] pointer-events-none"></div>
      
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8">
        {/* Version badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#3a3d4f] bg-[#22242f]/50 px-3 py-1 text-xs font-medium text-[#bd93f9]">
          <span className="flex h-2 w-2 rounded-full bg-[#bd93f9] animate-pulse"></span>
          v1.0 is now live
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight">
          One Endpoint for <br/>
          <span className="text-[#bd93f9]">All AI Providers</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full">
          ...
          <a 
            ...
            className="h-12 px-8 rounded-lg border border-[#3a3d4f] bg-[#22242f] hover:bg-[#3a3d4f] text-white text-base font-bold transition-all flex items-center gap-2"
          >
