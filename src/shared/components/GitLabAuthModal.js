          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 border border-border rounded-[var(--radius-brand-lg)] hover:border-primary hover:bg-primary/5 transition-colors text-left"
              >
