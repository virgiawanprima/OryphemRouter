...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/virgiawanprima/OryphemRouter/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://oryphem.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "oryphemrouter",
  installCmd: "npm i -g oryphemrouter",
  installCmdLatest: "npm i -g oryphemrouter@latest --prefer-online",
