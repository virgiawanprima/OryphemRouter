/**
 * `oryphemrouter xai video` — generate a Grok Imagine video through the local
 * oryphemrouter gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: oryphemrouter xai video --prompt "..." [options]

Generate a Grok Imagine video via your local oryphemrouter gateway
...
Options:
  ...
  --api-key <key>         oryphemrouter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-oryphemrouter-connection-id"] || null;
