 ...
 *   2. `process.argv[1]` if it's our cli.js — true when oryphemrouter is currently
 ...
 * SIGTERM to the running process. When the running oryphemrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/oryphemrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/oryphemrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `oryphemrouter.cmd` lookup that depended on the npm prefix path.
