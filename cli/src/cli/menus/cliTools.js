...
async function buildCodexHeader() {
  ...
  const { installed, hasOryphemRouter, config } = result.data;
...
async function buildDroidHeader() {
  ...
  const { installed, hasOryphemRouter, settings } = result.data;
...
async function buildOpenCodeHeader() {
  ...
  const { installed, hasOryphemRouter, opencode } = result.data;
