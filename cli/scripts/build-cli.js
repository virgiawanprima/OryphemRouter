...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/oryphemrouter/server.js.
...
function buildCliPackage() {
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.oryphemrouter/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.oryphemrouter/runtime)");
  }
  console.log("");
