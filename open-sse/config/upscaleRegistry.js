...
const DEFAULT_UPSCALE_FACTORS = Object.freeze([2, 4]);
...
function isRegisteredUpscaleModel(modelStr) {
  return getUpscaleModelEntry(modelStr) !== null;
}
function normalizeUpscaleFactor(value, allowed = DEFAULT_UPSCALE_FACTORS) {
...
function normalizeCreativityPercent(value, fallback = 0) {
  let n = NaN;
