 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what oryphemrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a oryphemrouter
 ...
 * The suffix is a oryphemrouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a oryphemrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a oryphemrouter synthetic thinking variant
...
/**
 * Resolve a oryphemrouter model id to the real upstream Kiro model id, plus flags
