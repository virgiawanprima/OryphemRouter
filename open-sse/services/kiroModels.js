 ...
 * into oryphemrouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are oryphemrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic oryphemrouter variant set for a single upstream Kiro model.
 *
 ...
 * into oryphemrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
