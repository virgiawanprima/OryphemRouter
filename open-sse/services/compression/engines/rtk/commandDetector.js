import { lastCommandSegment } from "./splitCompositeCommand.js";
...
function detectCommandFromText(text) {
...
function detectCommandType(text, command) {
...
const detectCommandOutput = detectCommandType;
export {
