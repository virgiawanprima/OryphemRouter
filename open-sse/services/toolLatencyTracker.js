...
function recordToolLatency(provider, ttftAfterToolMs, gapAfterToolMs) {
  if (!provider) return;
...
function getToolLatencyByProvider() {
  const result = {};
...
function recordToolTtft(provider, ttftMs) {
