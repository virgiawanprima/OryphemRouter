/**
 * Provider-plugin manifest URL helpers (ported from OmniRoute
...
export function resolveProviderPluginManifestUrl(origin) {
...
export function getProviderPluginManifestHeader(origin) {
  return {
