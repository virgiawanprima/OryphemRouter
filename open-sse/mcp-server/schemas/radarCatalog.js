import { z } from "zod";
const radarCatalogInput = z.object({
...
const radarCatalogOutput = z.object({
  meta: z.object({
    version: z.string(),
    tier: z.string(),
    fetchedAt: z.string()
...
const radarCatalogTool = {
  name: "omniroute_radar_catalog",
  description: "Reads the local signed Radar catalog with optional provider and curated-family filters. Never syncs or writes data.",
