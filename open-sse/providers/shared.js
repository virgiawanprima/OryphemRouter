...
// Keep this static even when oryphemrouter runs on Linux: the provider profile is
...
// Loaded from environment variables (see .env.example) — do NOT hardcode secrets in source.
