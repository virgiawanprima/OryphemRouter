    ...
    if (typeof WebAssembly.instantiateStreaming === "function") {
      try {
        ...
        if (validResponse && module.headers.get("Content-Type") !== "application/wasm") {
          log.warn("TINYCMS", "`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", e);
        } else {
          throw e;
        }
      }
...
function initSync(module) {
  ...
  if (module !== void 0) {
    if (Object.getPrototypeOf(module) === Object.prototype) {
      ...
      log.warn("TINYCMS", "using deprecated parameters for `initSync()`; pass a single object instead");
    }
  }
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path !== void 0) {
    if (Object.getPrototypeOf(module_or_path) === Object.prototype) {
      ...
      log.warn("TINYCMS", "using deprecated parameters for the initialization function; pass a single object instead");
    }
  }
  if (module_or_path === void 0) {
...
async function initTinyCmsWasm() {
...
function generateSecurePayload(username, timestamp, nonce_js, challenge, client_ip, difficulty) {
  return generate_secure_payload(username, timestamp, nonce_js, challenge, client_ip, difficulty);
}
export {
