...
import { exchangeKimiRefreshToken } from "../utils/omni/kimiTokenRefresh.js";
import {
  resolveKimiWebContextLength,
  resolveKimiWebModelConfig,
  resolveKimiWebReasoningEffort
} from "../utils/omni/kimiWebRuntime.js";
function getKimiWebBaseUrl() {
...
function getConnectEndStreamError(frame) {
  if ((frame.flags & 2) === 0) return null;
